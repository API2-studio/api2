{application,json_schema,
             [{applications,[kernel,stdlib,elixir,logger,jason,typed_struct]},
              {description,"A library for parsing, inspecting and manipulating JSON Schema documents.\n"},
              {modules,['Elixir.JsonSchema','Elixir.JsonSchema.Parser',
