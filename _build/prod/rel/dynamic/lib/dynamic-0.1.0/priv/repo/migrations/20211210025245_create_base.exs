defmodule Dynamic.Repo.Migrations.CreateBase do
  ...
  def change do
    ...
    create table(:base, primary_key: true) do
    ...
    create index(:base, [:archived_at])
    create index(:base, [:deleted_at])
    create index(:base, [:inserted_at])
    create index(:base, [:updated_at])
